...
using DH.Lending.Microservice.Common;
...
namespace Presentation.MicroService.Borrower
{
    ...
    /// </summary>
    internal sealed class BorrowerService : StatelessService
    {
        /// <summary>
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            ...
            return new[]
            {
                new ServiceInstanceListener(initParams => new OwinCommunicationListener(string.Empty, new Startup(), initParams))
            };
        }
