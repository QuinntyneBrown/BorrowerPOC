...
namespace Api.Sdk
{
    public static partial class BorrowerExtensions
    {
        ...
        {
            Microsoft.Rest.HttpOperationResponse<Api.Sdk.Models.BorrowerDto> result = await operations.PostByBorrowerWithOperationResponseAsync(borrower, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
