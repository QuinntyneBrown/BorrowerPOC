...
using DH.Lending.Borrower.Presentation.Api;
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        //c.SingleApiVersion("v1", "Presentation.Api");
                        ...
                        c.MultipleApiVersions((apiDesc, version) =>
                        {
                            ...
                            return CultureInfo.InvariantCulture.CompareInfo.IndexOf(controllerNamespace, $".{version}.", CompareOptions.IgnoreCase) >= 0;
                        }, builder =>
                        {
                            builder.Version("v3", "Lending 2.0 API V3");
                            builder.Version("v2", "Lending 2.0 API V2");
                            builder.Version("v1", "Lending 2.0 API V1");
                        });
                        ...
                        /*c.OAuth2("oauth2")
                            ...
                            .Flow("implicit")
                            .AuthorizationUrl("https://login.microsoftonline.com/f04267fa-02b0-4cc7-97e5-a313de0dcc93/oauth2/authorize")
                            .TokenUrl("https://login.microsoftonline.com/f04267fa-02b0-4cc7-97e5-a313de0dcc93/oauth2/token")
                            .Scopes(scopes =>
                            {
